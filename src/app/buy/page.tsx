        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          ...
          >
            ...
            >
              ...
              <span className="text-white/90 text-sm font-medium">{pagination.total.toLocaleString()} Homes for Sale</span>
            </motion.div>
            ...
            <p className="text-lg text-white/80 mb-8 text-center">Browse thousands of homes across the country</p>
