        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          ...
          >
            ...
            >
              ...
              <span className="text-white/90 text-xs sm:text-sm font-medium">{pagination.total.toLocaleString()} Homes for Sale</span>
            </motion.div>
            ...
            <p className="text-sm sm:text-base md:text-lg text-white/80 mb-6 sm:mb-8 text-center">Browse thousands of homes across the country</p>
                    ...
                    <div className={`bg-card border border-border rounded-2xl overflow-hidden hover:shadow-lg transition-all ${
                      ...
                      <div className={`relative overflow-hidden ${
                        ...
                        {property.status === 'ACTIVE' ? (
                          <span className="absolute top-3 left-3 px-3 py-1 bg-emerald-500 text-white text-xs font-medium rounded-full">For Sale</span>
                        ) : property.status === 'PENDING' ? (
                          <span className="absolute top-3 left-3 px-3 py-1 bg-amber-500 text-white text-xs font-medium rounded-full">Pending</span>
                        ) : (
                          <span className="absolute top-3 left-3 px-3 py-1 bg-muted-foreground text-white text-xs font-medium rounded-full">Sold</span>
                        )}
